...
echo "Start solving Ax = b with method a"
$MPICC $LIB -g main.cpp -o main $MKL
mpirun -n 8 -f ~/mpd.hosts -perhost 1 -genv I_MPI_DEVICE=ssm  -genv OMP_NUM_THREADS 8 ./main A_ndd.mtx b_ndd.mtx x.mtx
#mpirun -n 8 -f ~/mpd.hosts -perhost 1 -genv I_MPI_DEVICE=ssm  -genv OMP_NUM_THREADS 8 ./main tinyA_ndd.mtx tinyb_ndd.mtx x_a.mtx

echo -e "\n\nStart solving Ax = b with method b"
$MPICC $LIB -g gmres.cpp -o main $MKL

mpirun -n 8 -f ~/mpd.hosts -perhost 1 -genv I_MPI_DEVICE=ssm  -genv OMP_NUM_THREADS 8 ./main A_ndd.mtx b_ndd.mtx x.mtx
#mpirun -n 8 -f ~/mpd.hosts -perhost 1 -genv I_MPI_DEVICE=ssm  -genv OMP_NUM_THREADS 8 ./main tinyA_ndd.mtx tinyb_ndd.mtx x_b.mtx
