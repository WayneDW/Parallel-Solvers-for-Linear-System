...
mpirun -n 8 -f ~/mpd.hosts -perhost 1 -genv I_MPI_DEVICE=ssm  -genv OMP_NUM_THREADS 8 ./main largeA.mtx largeb.mtx x.mtx


#mpirun -n 2 -f ~/mpd.hosts -perhost 1 -genv I_MPI_DEVICE=ssm  -genv OMP_NUM_THREADS 8 ./main tinyA.mtx tinyb.mtx x.mtx
#mpirun -n 2 -f ~/mpd.hosts -perhost 1 -genv I_MPI_DEVICE=ssm  -genv OMP_NUM_THREADS 8 ./main smallA.mtx smallb.mtx x.mtx
